...
-- CreateIndex
CREATE UNIQUE INDEX "Profession_userId_key" ON "Profession"("userId");
...
-- AddForeignKey
ALTER TABLE "Profession" ADD CONSTRAINT "Profession_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
